/**
 ...
 Used the code from https://github.com/rjshade/gmaps-autocomplete
 But also manipulated parts of it to accommodate our application
 by Andrew Song
 */
...
function gmaps_init(latitude,longitude,flag){

    if ((latitude!=null) && (longitude!=null)){
        var latlng = new google.maps.LatLng(latitude,longitude);
    }else{
        var latlng = new google.maps.LatLng(42.3584488,-71.0912204);
    }
    var options = {
        zoom: 15,
        center: latlng,
    ...
    map = new google.maps.Map(document.getElementById("gmaps-canvas"+flag), options);
...
$(document).ready(function() {
    ...
    if( $('#gmaps-canvas1').length  ) {
        gmaps_init(latitude,longitude,"1");
        autocomplete_init();
    };

    if( $('#gmaps-canvas2').length ) {
        gmaps_init(latitude,longitude,"2");
        autocomplete_init();
    }
